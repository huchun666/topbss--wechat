...
var OrderStore = (function () {
    ...
    //更新的函数
    OrderStore.prototype.warehouseUpdate = function (index) {
        var _this = this;
        var body = [];
...
var AppService = (function () {
    ...
    AppService.prototype.handleError = function (error) {
        ...
        if (error.status == 401 && error.json().error == "invalid_token") {
            ...
            this.oauthTokenHeaders = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]({
                'Authorization': 'Basic ' + base64encode,
                'Content-Type': 'application/x-www-form-urlencoded'
            });
            ...
            this.httpPostHeader(oauthTokenUrl, body, this.oauthTokenHeaders).then(function (data) {
                ...
                console.log(err);
                _this.toast('网络异常，请稍后重试', 1000, 'middle');
            });
        }
        else {
