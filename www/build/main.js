...
var OrderLayer = (function () {
    ...
    // 切换sku属性时
    OrderLayer.prototype.changeRadio = function (event, index, skuAttrAttrValue) {
        var _this = this;
        ...
        this.appService.httpGet(url).then(function (data) {
            ...
            _this.appService.getToken(error, function () {
                _this.changeRadio(event, index, skuAttrAttrValue);
            });
            console.log(error);
            _this.appService.toast('操作失败，请稍后重试', 1000, 'middle');
        });
